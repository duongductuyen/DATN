            ...
            <div class="col-sm-3">
                <div class="product-image-wrapper">
                    ...
                    <div class="single-products">
                        <div style="height: 420px;" class="productinfo text-center">
                            <form>
                                @csrf
                                ...
                                <a href="{{URL::to('/chi-tiet/'.$product->product_slug)}}">
                                    ...
                                    <h2 style="margin-top: 10px;">{{number_format($product->product_price,0,',','.').' '.'VNĐ'}}</h2>
                                    <p style="margin: 0 10px 20px 10px;">{{$product->product_name}}</p>
