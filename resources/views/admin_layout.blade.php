...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
  ...
  <!-- //font-awesome icons CSS-->
  <!-- side nav css file -->
  <link href="{{asset('public/backend/css/SidebarNav1.min.css')}}" media="all" rel="stylesheet" type="text/css" />
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview ">
                ...
                <ul class="treeview-menu">
                  <li><a href="{{URL::to('/add-category-post')}}"><i class="fa fa-angle-right"></i>Thêm danh mục bài viết</a></li>
                  <li><a href="{{URL::to('/all-category-post')}}"><i class="fa fa-angle-right"></i>Liệt kê danh mục bài viết</a></li>
                </ul>
              </li>
              ...
              <li class="treeview ">
                ...
                <ul class="treeview-menu">
                  <li><a href="{{URL::to('/add-post')}}"><i class="fa fa-angle-right"></i>Thêm bài viết</a></li>
                  <li><a href="{{URL::to('/all-post')}}"><i class="fa fa-angle-right"></i>Liệt kê bài viết</a></li>
                </ul>
              </li>
