...
class HomeController extends Controller
{
    ...
    public function index(Request $request){
    	...
    	return view('pages.home')->with('category',$cate_product)->with('brand',$brand_product)->with('all_product',$all_product)->with('meta_desc',$meta_desc)
        ->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('slider',$slider)->with('contact',$contact)
        ->with('cate_pro_tabs',$cate_pro_tabs)->with('category_post',$category_post); //1
    ...
    public function search(Request $request){
        ...
        ->with('slider',$slider)->with('contact',$contact)->with('category_post',$category_post);
