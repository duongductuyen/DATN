...
class ProductController extends Controller
{
    ...
    public function details_product($product_slug , Request $request){
       ...
       // related product
        ...
        ->with('url_canonical',$url_canonical)->with('slider',$slider)->with('contact',$contact)->with('gallery',$gallery)->with('product_cate',$product_cate)
        ->with('cate_slug',$cate_slug)->with('category_post',$category_post);
