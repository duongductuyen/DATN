...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home(Request $request ,$slug_category_product){
       ...
       //slide
        ...
        ->with('url_canonical',$url_canonical)->with('slider',$slider)->with('contact',$contact)->with('min_price',$min_price)->with('max_price',$max_price)
        ->with('max_price_range',$max_price_range)->with('min_price_range',$min_price_range)->with('category_post',$category_post);
