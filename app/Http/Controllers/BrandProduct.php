...
class BrandProduct extends Controller
{
    ...
    //End Function Admin Page
     ...
     public function show_brand_home(Request $request, $brand_slug){
        ...
        ->with('brand_name',$brand_name)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)
        ->with('url_canonical',$url_canonical)->with('slider',$slider)->with('contact',$contact)->with('category_post',$category_post);
    }
}