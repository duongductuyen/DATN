...
class PostController extends Controller
{
    ...
    public function save_post(Request $request){
       ...
       if($get_image){
           ...
           Session::put('message','Bạn phải thêm ảnh đại diện cho bài viết');
           return redirect()->back();
       }
    }
    ...
    public function danh_muc_bai_viet(Request $request, $post_slug){
        ...
        //slide
         ...
         ->with('url_canonical',$url_canonical)->with('slider',$slider)->with('post',$post)->with('category_post',$category_post);
    ...
    public function bai_viet(Request $request, $post_slug){
        ...
        //slide
         ...
         ->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)
         ->with('url_canonical',$url_canonical)->with('slider',$slider)->with('post',$post)->with('category_post',$category_post)->with('related',$related);
